"""Boîte de dialogue d'ajout / modification d'un afficheur."""
...
from app.services import StockError, create_display, update_display
...
class DisplayDialog(QDialog):
    """Formulaire d'ajout ou de modification d'un afficheur.
    ...
    def __init__(self, display_id: int | None = None) -> None:
        ...
        self.setWindowTitle(
            "Modifier l'afficheur" if display_id else "Ajouter un afficheur"
        )
    ...
    def _build_ui(self) -> None:
        ...
        self.color_input.setPlaceholderText("Ex : Noir")
        ...
        self.sale_price_input = ModernDoubleSpinBox()
    ...
    def _load_display(self, display_id: int) -> None:
        with session_scope() as session:
            ...
            self.color_input.setText(display.color)
            self.purchase_price_input.setValue(cents_to_da(display.purchase_price_cents))
            self.sale_price_input.setValue(cents_to_da(display.sale_price_cents))
    ...
    def _on_save(self) -> None:
        fields = dict(
            ...
            sale_price_cents=da_to_cents(self.sale_price_input.value()),
