...
class HiddenStatCard(QFrame):
    """Carte statistique avec valeur masquée par défaut, révélable par un clic sur l'oeil."""
    ...
    def __init__(
        ...
        *,
        ...
        self._eye_btn.setObjectName("SecondaryButton")
        self._eye_btn.setFixedHeight(26)
        self._eye_btn.setStyleSheet("font-size: 11px; padding: 0 8px;")
        self._eye_btn.clicked.connect(self._toggle)
        header.addWidget(self._eye_btn, alignment=Qt.AlignmentFlag.AlignTop)
    ...
    def _toggle(self) -> None:
        ...
        if self._revealed:
            self.value_label.setText(self._real_value)
            self._eye_btn.setText("Masquer")
        else:
            self.value_label.setText("• • • • •")
            self._eye_btn.setText("Afficher")
